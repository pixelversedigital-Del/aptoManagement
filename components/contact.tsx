...
import contactVisual from "@/assets/images/contact-visual.svg"
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
          <div className="animate-fade-up">
            ...
            <a
              href="#contact-form"
              className="inline-flex items-center justify-center rounded-full border border-foreground bg-transparent px-6 py-3 text-sm font-semibold text-foreground hover:bg-foreground hover:text-background transition-colors glow-on-hover"
            >
              Get in Touch
            </a>
            ...
            <div className="mt-12 space-y-6">
              <div className="overflow-hidden rounded-2xl border border-border bg-card hover-lift">
                <Image
                  src={contactVisual}
                  alt="Contact and support visual"
                  className="h-52 w-full object-cover transition-transform duration-500 hover:scale-105"
                />
              </div>
              <div className="flex items-center gap-4 rounded-xl px-3 py-2 transition-colors duration-200 hover:bg-card/60">
                ...
                <div>
                  ...
                  <a href="tel:+911206870897" className="font-medium text-foreground">+91 120 687 0897</a>
                </div>
              </div>
              ...
              <div className="flex items-center gap-4 rounded-xl px-3 py-2 transition-colors duration-200 hover:bg-card/60">
                ...
                <div>
                  ...
                  <a href="mailto:info@aptoservices.com" className="font-medium text-foreground">info@aptoservices.com</a>
                </div>
              </div>
              ...
              <div className="flex items-center gap-4 rounded-xl px-3 py-2 transition-colors duration-200 hover:bg-card/60">
                ...
                <div>
                  ...
                  <p className="font-medium text-foreground">401, 402, 4th Floor, Ithum Heights, Sector 62, Noida, UP - 201309</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div id="contact-form" className="animate-fade-up">
            <div className="bg-card border border-border rounded-2xl p-8 hover-lift">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <button
                  type="submit"
                  className="w-full sm:w-auto rounded-full border border-foreground bg-transparent px-8 py-3 text-sm font-semibold text-foreground hover:bg-foreground hover:text-background transition-colors glow-on-hover"
                >
                  Submit
                </button>
              </form>
