...
const focusAreas = [
    {
        ...
        description:
            "Build stable, high-performing teams with long-term hiring support tailored to your organization.",
    },
    {
        title: "Staffing Solutions",
        description:
            "Scale teams quickly with flexible staffing models aligned to your project and business needs.",
    },
    {
        title: "Resume ATS Solutions",
        description:
            "Filter high-volume applications faster and surface the right talent with ATS-enabled screening workflows.",
    },
];
            ...
            <div className="mx-auto max-w-7xl px-6 lg:px-8 space-y-16">
                ...
                <div>
                    ...
                    <h3 className="max-w-3xl text-2xl font-bold tracking-tight text-foreground sm:text-3xl">
                        Hire top talent with practical, technology-enabled recruitment
                        support.
                    </h3>
                    <div className="mt-8 grid gap-6 md:grid-cols-3">
                        {focusAreas.map((area) => (
                            <article
                                key={area.title}
                                className="rounded-2xl border border-border bg-background p-6 hover-lift animate-fade-up"
                            >
